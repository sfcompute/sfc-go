...
// InstanceSKUCatalog - Browse available instance SKU property definitions.
type InstanceSKUCatalog struct {
	rootSDK          *SDK
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newInstanceSKUCatalog(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *InstanceSKUCatalog {
	return &InstanceSKUCatalog{
		rootSDK:          rootSDK,
