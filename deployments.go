...
// Deployments - Deployment automations that maintain a fleet of instances on a capacity.
...
func newDeployments(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Deployments {
	return &Deployments{
		rootSDK:          rootSDK,
...
func (s *Deployments) List(ctx context.Context, request operations.ListDeploymentsRequest, opts ...operations.Option) (*operations.ListDeploymentsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/preview/v2/deployments")
	if err != nil {
...
func (s *Deployments) GetDeployment(ctx context.Context, id string, expand []operations.GetDeploymentExpand, opts ...operations.Option) (*operations.GetDeploymentResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/preview/v2/deployments/{id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
