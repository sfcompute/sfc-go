...
// Users - Read-only access to users within the caller's organization.
type Users struct {
	rootSDK          *SDK
...
func newUsers(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Users {
	return &Users{
		rootSDK:          rootSDK,
...
func (s *Users) List(ctx context.Context, request operations.ListUsersHandlerRequest, opts ...operations.Option) (*operations.ListUsersHandlerResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/preview/v2/users")
	if err != nil {
	...
	res := &operations.ListUsersHandlerResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	}
	res.Next = func() (*operations.ListUsersHandlerResponse, error) {
...
func (s *Users) GetUserHandler(ctx context.Context, id string, opts ...operations.Option) (*operations.GetUserHandlerResponse, error) {
	request := operations.GetUserHandlerRequest{
		ID: id,
	}
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/preview/v2/users/{id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetUserHandlerResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
